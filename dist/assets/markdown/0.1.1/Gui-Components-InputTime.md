...
### setButtonOnlyWhenFocused
    ...
    \Gui\Components\InputTime Gui\Components\InputTime::setButtonOnlyWhenFocused(boolean $option)
...
### isButtonOnlyWhenFocused
    ...
    boolean Gui\Components\InputTime::isButtonOnlyWhenFocused()
...
### setAcceptInput
    ...
    \Gui\Components\InputTime Gui\Components\InputTime::setAcceptInput(string $bool)
...
### getAcceptInput
    ...
    string Gui\Components\InputTime::getAcceptInput()
...
### setValue
    ...
    \Gui\Components\InputTime Gui\Components\InputTime::setValue(string $value)
...
### getValue
    ...
    string Gui\Components\InputTime::getValue()
