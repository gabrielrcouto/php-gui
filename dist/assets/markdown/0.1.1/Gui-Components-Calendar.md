...
### setValue
    ...
    \Gui\Components\Calendar Gui\Components\Calendar::setValue(string $value)
...
### getValue
    ...
    string Gui\Components\Calendar::getValue()

Gets the value of component;

In the Lazarus documentation for the TCalendar component there is a
 reference to the docs/lcl/calendar/tcustomcalendar.date.html Date
