...
### setValue
    ...
    \Gui\Components\TextArea Gui\Components\TextArea::setValue(string $value)
...
#### Arguments
* $value **string** - &lt;p&gt;the value&lt;/p&gt;



### getValue

    string Gui\Components\TextArea::getValue()
